    ...
    <div className="min-h-screen w-full bg-black/20 flex flex-col items-center justify-center">
      <div className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className='w-[90%] max-w-[400px]'>
          ...
          Wishnya semoga panjang umur ya mass sehat selalu dan semoga kebahagiaan selalu menyertaimu. Semoga segala urusan mas selalu dipermudah sama Allah SWT dan diluaskan sabarnya dalam menghadapi pacarmu ini haha.. I love u soooo much sayangkuuuu          </p>
