            ...
            <div className="content">
              ...
              <div className="letter" ref={letterRef}>
                <div className="body">
                  ...
                  <div className="message">Happy birthday mas!!!🤍 harusnya sih web ini isinya tentang kamu aja ya haha tapi aku mau isinya tentang kita, soalnya adek mau mas selalu inget sama aku haha :p</div>
                </div>
              </div>
            </div>
          </div>
